...
view: security_logs {
  derived_table: {
    ...
    sql:
      SELECT
        CURRENT_DATETIME() AS activity_timestamp, 'bigquery.googleapis.com' AS service_name, 'asjadnasir@google.com' AS principal_email, 'No' AS granted
      UNION ALL
      SELECT
         DATETIME_SUB(CURRENT_DATETIME(), INTERVAL 1 MINUTE) AS activity_timestamp, 'bigquery.googleapis.com' AS service_name, 'asjadnasir@google.com' AS principal_email, 'No' AS granted
      UNION ALL
      SELECT
